...
<ul>
  <li style="list-style-image: url('../../../dompdf/www/images/star_02.gif');"><a href="#installed-fonts">Installed fonts</a></li>
  <li style="list-style-image: url('../../../dompdf/www/images/star_02.gif');"><a href="#install-fonts">Install new fonts</a></li>
</ul>
    ...
    <tr>
      ...
      foreach($variants as $name => $path) {
        ...
        foreach ($extensions as $ext) {
          ...
          if (is_readable("../../../dompdf/www/$path.$ext")) {
            // if not cache file
            ...
            // cache file
              ...
              $content = file_get_contents("../../../dompdf/www/$path.$ext", null, null, null, 50);
              if (strpos($content, '$this->')) {
                $v = "DEPREC.";
              }
              else {
                ob_start();
                $d = include("../../../dompdf/www/$path.$ext");
                ob_end_clean();
...
<form name="upload-font" method="post" action="../../../dompdf/www/controller.php?cmd=install-font" target="upload-font" enctype="multipart/form-data" onsubmit="return checkFileName(this)">
...
<?php include("../../../dompdf/www/foot.inc"); ?>