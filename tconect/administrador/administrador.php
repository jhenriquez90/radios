              ...
              <div id="nav">
					<nav id="nav">
						<ul class= "nav">
                          ...
                          <li ><a href="../direccion/direccion.php">UNIDAD</a></li>
					...
					<div class="row">
						...
						<div id="sidebar" class="4u">
							<section>
								  ...
								  <ul class="style1">
										<li class="first">
											<p class="date"><img src="../pagina_principal/images/usuario.png" alt="" width="65" height="65" align="center"></p>
											<p><a href="../actualizar_usuario/usuarios.php">Crear, Modificar y/o Visualizar Usuarios.</a></p>
                                            
                                            
										</li>
									  <li>
											<p class="date"><img src="../pagina_principal/images/rdio.png" alt="" width="65" height="65" align="center"></p>
											<p><a href="../actualizar_equipo/equipo.php">Ingresar, Modificar y/o Visualizar Equipo.</a></p>
									</li>
									                                </section>
							</div>
						<!-- Sidebar -->
							...
							<div id="content" class="8u skel-cell-important">
							  <section>
								...
								<p>Podra disponer de las siguientes opciones::</p>
									<ul>
									  <li>1). Ingresar Usuario nuevo para administrar el  sistema.
									    <ul>
									      <li>2). Visualizar los Usuarios Existentes.</li>
									      <li>3). Modificar Usuarios. </li>
									      <li>4). Ingresar información del Equipo.</li>
									      <li>5). Visualizar los Equipos existentes.</li>
									      <li>6). Modificar la información de los Equipos.</li>
								        </ul>
									  </li>
									  ...
									  <li>3). Visitante, quien solo podra visualisar los equipos registrados.</li>
							    </ul>
